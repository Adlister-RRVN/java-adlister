...
<nav class="Navbar__">
  <div class="Navbar__container">
    <div class="Navbar__header">
      <a class="Navbar__brand" href="/" title="See Cars!">
    ...
    <div class="Navbar__container-links">
      <ul>
        <c:choose>
          ...
          <c:otherwise>
            <li>
              <a class="Navbar__profile-icon" href="/ads" title="Profile">View Ads</a>
            </li>
            <li><a class="Navbar__right-link" href="/ads/create" title="Logout">Create Ad</a></li>
          </c:otherwise>
        </c:choose>
      </ul>
    </div>
